...
public class EasyAnimations extends EasyMode{
    ...
    Thread redBloonAnimation = new Thread(() -> {
        ...
        while (hearths != 0) {
            ...
            if (BloonX >= cloud.getX() + 10 && BloonX - 10 <= cloud.getX() + 190 && BloonY >= cloud.getY() - 20 && BloonY <= cloud.getY() + 80) {
                redBloon.setEnabled(false);
            } else redBloon.setEnabled(BloonX < tree.getX() || BloonX > tree.getX() + 190 || BloonY < tree.getY() - 50);
            try {
                Thread.sleep(10);
            } catch (Exception e) {
    ...
    Thread greenBloonAnimation = new Thread(() -> {
        ...
        while (hearths != 0){
            ...
            } else greenBloon.setEnabled(BloonX < tree.getX() || BloonX > tree.getX() + 190 || BloonY < tree.getY() - 50);
            try{
                Thread.sleep(20);
            }catch (Exception e){
                System.out.println("Exception 3");
    ...
    Thread yellowBloonAnimation = new Thread(() -> {
        ...
        while (hearths != 0){
            ...
            }  else yellowBloon.setEnabled(BloonX < tree.getX() || BloonX > tree.getX() + 190 || BloonY < tree.getY() - 50);
            try{
                Thread.sleep(20);
            }catch (Exception e){
                System.out.println("Exception 3");
    ...
    Thread pinkBloonAnimation = new Thread(() -> {
        ...
        while (hearths != 0){
            ...
            }  else pinkBloon.setEnabled(BloonX < tree.getX() || BloonX > tree.getX() + 190 || BloonY < tree.getY() - 50);
            try{
                Thread.sleep(20);
            }catch (Exception e){
                System.out.println("Exception 3");
    ...
    Thread purpleBloonAnimation = new Thread(() -> {
        ...
        while (hearths != 0){
            ...
            } else purpleBloon.setEnabled(BloonX < tree.getX() || BloonX > tree.getX() + 190 || BloonY < tree.getY() - 50);
            try{
                Thread.sleep(20);
            }catch (Exception e){
                System.out.println("Exception 3");
