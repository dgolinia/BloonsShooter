...
public class HardMode extends JFrame implements KeyListener {
    ...
    JTextField ranking = new JTextField("123");
    ...
    HardMode(){
        ...
        redBloon.setBounds(-100,rand.nextInt(500),75,75);
        ...
        greenBloon.setBounds(1400,rand.nextInt(500),75,75);
        ...
        yellowBloon.setBounds(-100,rand.nextInt(500),75,75);
        ...
        pinkBloon.setBounds(-100,(rand.nextInt(500)),75,75);
        ...
        purpleBloon.setBounds(1400,rand.nextInt(500),75,75);
        ...
        mainPanel.add(leaveButton,Integer.valueOf(0));
        mainPanel.add(ranking,Integer.valueOf(10));
