...
public class EasyMode extends JFrame implements KeyListener {
    ...
    JLabel cloud,tree,floor,countingDown,lifes,scores,upgradesLabel,upgradesLabel2,stopwatch;
    ...
    EasyMode(){
        ...
        cloud.setBounds(150,100,200,100);

        tree = new JLabel(new ImageIcon("img/tree.png"));
        tree.setBounds(600,300,200,300);
        ...
        mainPanel.add(leaveButton,Integer.valueOf(10));
